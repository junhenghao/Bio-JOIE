...
class TFParts(object):
    ...
    def __init__(self, num_rels1, num_ents1, num_rels2, num_ents2, method='distmult', bridge='CG', dim1=300, dim2=100, batch_sizeK1=512, batch_sizeK2=512, batch_sizeA=256, batch_sizeT=64, m1=0.5, m2=1.0, mA=0.5, mT=0.5, L1=False):
